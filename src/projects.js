...
const projects = {
  client: [
    ...
    },
    {
      ...
      hero: natureClean1,
      splitImages: [{src: natureClean3, type: 'image', outline: true}, {src: natureClean2, type: 'image', outline: true}],
  ...
  personal: [
    {
      ...
      hero: acmiles1,
      splitImages: [{src: acmiles3, type: 'image'}, {src: acmiles2, type: 'image'}],
      video: acmiles4,
      listHeading: 'Goals',
      listItems: [
    ...
    },
    {
      ...
      hero: fishingGame1,
      splitImages: [{src: fishingGame2, type: 'image'}, {src: fishingGame4, type: 'video'}],
      video: fishingGame3,
      listHeading: 'Goals',
      listItems: [
